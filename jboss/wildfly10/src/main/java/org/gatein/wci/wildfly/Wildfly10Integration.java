...
public class Wildfly10Integration {
  private static final Logger              log                      = LoggerFactory.getLogger(Wildfly10Integration.class);
  ...
  private Wildfly10ServletContainerContext containerContext         = null;

  private ServletContainerService          servletContainerService;

  public Wildfly10Integration(ServletContainerService servletContainerService) {
  ...
  public void start() {
    if (start.compareAndSet(false, true)) {
      ...
      containerContext = new Wildfly10ServletContainerContext(servletContainer);
