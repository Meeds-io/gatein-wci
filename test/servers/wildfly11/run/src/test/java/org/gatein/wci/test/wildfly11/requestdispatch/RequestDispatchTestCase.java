 ...
 */
package org.gatein.wci.test.wildfly11.requestdispatch;
...
public class RequestDispatchTestCase extends AbstractRequestDispatchTestCase
{
   ...
   {
      WebArchive war = wciWildfly11Deployment("rdwci.war");
      war.setWebXML("org/gatein/wci/test/wildfly11/requestdispatch/web.xml");
