package org.gatein.wci.test.wildfly11.servletlistener;
...
public class ServletListenerTestCase extends AbstractServletListenerTestCase
{
   ...
   static
   {
      AbstractServletListenerTestCase.webXml = "org/gatein/wci/test/wildfly11/servletlistener/listener_web.xml";
   }

   @Deployment(name = "servletlistenerwci", order = 1)
   public static WebArchive wciDeployment()
   {
      WebArchive war = wciWildfly11Deployment("servletlistenerwci.war");
      war.setWebXML("org/gatein/wci/test/wildfly11/servletlistener/web.xml");
