 ...
 */
package org.gatein.wci.test.wildfly11.crosscontext;
...
public class CrossContextTestCase extends AbstractWCITestCase {
  ...
  public static Archive<?> deployment() {
    ...
    ear.addAsManifestResource("org/gatein/wci/test/wildfly11/crosscontext/jboss-all.xml", "jboss-all.xml");
    ...
    war.setWebXML("org/gatein/wci/test/wildfly11/crosscontext/web.xml");
    war.addAsWebInfResource("org/gatein/wci/test/wildfly11/crosscontext/jboss-web.xml", "jboss-web.xml");
    ear.addAsModule(war);
