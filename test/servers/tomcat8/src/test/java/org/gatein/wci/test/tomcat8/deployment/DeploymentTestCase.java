 ...
 */
package org.gatein.wci.test.tomcat8.deployment;
...
public class DeploymentTestCase extends AbstractDeploymentTestCase
{
   ...
   public static WebArchive wciDeployment()
   {
      ...
      war.setWebXML("org/gatein/wci/test/tomcat8/deployment/web.xml");
      war.addAsManifestResource("org/gatein/wci/test/tomcat8/deployment/context.xml", "context.xml");
