 ...
 */
package org.gatein.wci.test.tomcat.requestdispatch;
...
public class RequestDispatchTestCase extends AbstractRequestDispatchTestCase
{
   ...
   public static WebArchive wciDeployment()
   {
      ...
      war.setWebXML("org/gatein/wci/test/tomcat/requestdispatch/web.xml");
      war.addAsManifestResource("org/gatein/wci/test/tomcat/requestdispatch/context.xml", "context.xml");
