 ...
 */
package org.gatein.wci.test.wildfly10.deployment;
...
public class DeploymentTestCase extends AbstractDeploymentTestCase
{
   ...
   {
      WebArchive war = wciWildfly10Deployment("deploymentwci.war");
      war.addClass(AbstractDeploymentTestCase.class);
      war.setWebXML("org/gatein/wci/test/wildfly10/deployment/web.xml");
