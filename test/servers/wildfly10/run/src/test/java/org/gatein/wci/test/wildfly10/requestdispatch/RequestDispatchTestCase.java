 ...
 */
package org.gatein.wci.test.wildfly10.requestdispatch;
...
public class RequestDispatchTestCase extends AbstractRequestDispatchTestCase
{
   ...
   {
      WebArchive war = wciWildfly10Deployment("rdwci.war");
      war.setWebXML("org/gatein/wci/test/wildfly10/requestdispatch/web.xml");
