 ...
 */
package org.gatein.wci.test.wildfly10.authentication;
...
public class AuthenticationTestCase extends AbstractAuthenticationTestCase
{
   ...
   {
      WebArchive war = wciWildfly10Deployment(null);
      war.setWebXML("org/gatein/wci/test/wildfly10/authentication/web.xml");
      war.addAsWebInfResource("org/gatein/wci/test/wildfly10/authentication/jboss-web.xml", "jboss-web.xml");
