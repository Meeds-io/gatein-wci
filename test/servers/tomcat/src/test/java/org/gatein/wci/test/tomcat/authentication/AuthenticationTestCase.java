 ...
 */
package org.gatein.wci.test.tomcat.authentication;
...
public class AuthenticationTestCase extends AbstractAuthenticationTestCase
{
   ...
   public static WebArchive wciDeployment()
   {
      ...
      war.setWebXML("org/gatein/wci/test/tomcat/authentication/web.xml");
      war.addAsManifestResource("org/gatein/wci/test/tomcat/authentication/context.xml", "context.xml");
