 ...
 */
package org.gatein.wci.test.glassfish3.deployment;
...
public class DeploymentTestCase extends AbstractDeploymentTestCase
{
   ...
   public static WebArchive deployWar()
   {
      ...
      war.setWebXML("org/gatein/wci/test/glassfish3/deployment/web.xml");
      war.addAsManifestResource("org/gatein/wci/test/glassfish3/deployment/context.xml", "context.xml");
      return war;
   }
}
